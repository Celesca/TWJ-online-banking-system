  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-start mx-auto p-4">
    ...
    <div className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
      <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50  md:flex-row md:mt-0 md:border-0 md:bg-white">
        <li>
          <a href="/home" className="block py-2 px-3 text-gray-900 rounded" aria-current="page">Home</a>
        </li>
        <li>
          <a href="#" className="block py-2 px-3 text-gray-900 rounded">Services</a>
        </li>
        <li>
    ...
    <div className="flex items-center m-auto">
      <a href="/account" className="block py-2 px-3 text-gray-900 rounded">Account</a>
    </div>
  </div>
</nav>
    </div>
